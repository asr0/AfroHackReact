            ...
            <div>
                ...
                <div className="container text-center mt-4">
                    ...
                    <div className="mx-auto" style={{ width: 250 }}>
                        <button type="button" className="mb-4 d-block btn btn-primary font-weight-bold border-0" onClick={{}} data-toggle="modal" data-target="#inputModalMentor" style={{ borderRadius: 20, backgroundColor: '#FF5B01', width: 250, height: 50, fontSize: 20, }}>Quero ser mentor</button>

                        <button type="button" className="mb-4 d-block btn btn-primary font-weight-bold border-0" onClick={{}} style={{ borderRadius: 20, backgroundColor: '#FF5B01', width: 250, height: 50, fontSize: 20 }}>Quero ser mentorado</button>

                        <button type="button" className=" mb-4 border-0 font-weight-bold bg-transparent btn shadow-none" onClick={{}} style={{ color: '#462842', fontSize: 20, width: 200,  }}>Já tenho cadastro</button>
                    </div>
